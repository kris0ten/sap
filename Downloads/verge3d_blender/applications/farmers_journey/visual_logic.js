 ...
 * Sun Oct 03 2021 10:32:40 GMT+0300 (Moscow Standard Time)
...
/* Cordova mobile */
eventHTMLElem('deviceready', ['DOCUMENT'], true, function(event) {
  removeHTMLElement('fullscreen_button', true);
});
eventHTMLElem('pause', ['DOCUMENT'], true, function(event) {
  game_started = 0;
...
eventHTMLElem('resume', ['DOCUMENT'], true, function(event) {
  game_started = 1;
