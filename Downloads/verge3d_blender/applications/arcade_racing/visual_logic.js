 ...
 * Sun Oct 03 2021 10:32:15 GMT+0300 (Moscow Standard Time)
        ...
        for (var i = 0; i < _pGlob.syncList.length; i++) {
            ...
            if (syncData.obj == obj) {
                ...
                case 'ENABLE_SIMULATION':
                    ...
                    _pSetObjToBodyTransform(syncData.obj, body);
...
function snapBody(objName, targetObjName) {
    ...
    for (var i = 0; i < _pGlob.syncList.length; i++) {
        ...
        if (syncData.obj == obj) {
            ...
            _pSetObjToBodyTransform(obj, syncData.body);
...
registerEveryFrame(function() {
  if (game_started == true) {
    if (moving_side == 'left' && getDistanceBetweenObjects('Camera', 'camera_base_point') < 2) {
      ...
      animateParam(getObjTransform('Camera', false, 'position', 'x'), 0, 0.1, 'Linear', 'InOut', 0, false,
          function() {
      ...
      animateParam(getObjTransform('Camera', false, 'position', 'y'), getObjTransform('camera_base_point', false, 'position', 'y'), 0.1, 'Linear', 'InOut', 0, false,
          function() {
        setObjTransform('Camera', false, 'position', ['', _pGlob.animateParamUpdate || 0, ''], false);
      },
          function() {});
      ...
      animateParam(getObjTransform('Camera', false, 'position', 'z'), getObjTransform('camera_base_point', false, 'position', 'z'), 0.1, 'Linear', 'InOut', 0, false,
          function() {
        setObjTransform('Camera', false, 'position', ['', '', _pGlob.animateParamUpdate || 0], false);
      },
          function() {});
